        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {matches.map((m, idx) => (
            <div key={m.teamA} className="rounded-3xl border border-slate-200 bg-white/70 p-6 shadow-sm">
              ...
              <button
                type="button"
                className="mt-5 w-full rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-900 shadow-sm transition hover:bg-slate-50"
              >
                Manage match
              </button>
            </div>
