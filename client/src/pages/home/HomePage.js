...
function HomePage() {
    ...
    return [
      {
        ...
        teamA: "St. Peter's College",
        teamB: "Wesley College",
        scoreA: 22 + (delta > 2 ? 1 : 0),
        scoreB: 17 + (delta > 3 ? 1 : 0),
        time: "LIVE",
      },
      {
        league: "Battle of the Blues",
        teamA: "Royal College",
        teamB: "S. Thomas' College",
        scoreA: 142 + (delta % 3),
        scoreB: 128 + (delta % 2),
        time: "LIVE",
      },
      {
        league: "Lovers' Quarrel — Galle",
        teamA: "Richmond College",
        teamB: "Mahinda College",
        scoreA: 0,
        scoreB: 0,
        time: "SOON",
      },
  ...
  const news = [
    { title: "Mahinda College & Richmond: Lovers' Quarrel week guide", tag: "Southern schools", date: "This week" },
    { title: "Sri Lanka University Games — campus fixtures released", tag: "Universities", date: "Update" },
    { title: "President's Trophy rugby: knockout routes & venues", tag: "Schools rugby", date: "New" },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="relative lg:col-span-7">
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
                ...
                <span className="block bg-gradient-to-r from-emerald-400 via-lime-300 to-green-200 bg-clip-text text-transparent">
                  Sri Lankan school & university sports
                </span>
              </h1>

              <p className="mt-4 max-w-xl text-base text-slate-200">
                A focused platform for Sri Lankan schools rugby, big match cricket, and university games — from Colombo
                derbies to Galle and Kandy rivalries.
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                ...
                <Link
                  to="/coaches"
                  className="rounded-xl border border-lime-300/50 bg-lime-500/15 px-6 py-3 text-center text-xs font-bold text-lime-50 shadow-sm transition hover:border-lime-200/70 hover:bg-lime-500/25"
                >
              ...
              <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
                {[
                  { k: "Schools", v: "Big matches & knockouts" },
                  { k: "Campus", v: "SLUG & inter-uni rugby" },
                  { k: "Island-wide", v: "District-aware fixtures" },
                ].map((s, idx) => (
                  <div
                    key={s.k}
      ...
      <section id="sports" className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <SectionHeading
            kicker="Sports"
            title="From schools knockouts to campus finals"
            subtitle="Rugby, cricket, basketball, and athletics — framed for Sri Lankan school and university calendars."
          />
      ...
      <section id="matches" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <SectionHeading
          kicker="Matches"
          title="Live school & campus scoreboard"
          subtitle="Open a full match center with stats, lineups, timeline, and scorecard — tuned for Sri Lankan school and university fixtures."
        />

        <div className="grid gap-6 lg:grid-cols-3">
          {matches.map((m, idx) => {
            const scoreboardIds = ["sb_m_live_football", "sb_m_live_school_cricket", "sb_m_upcoming_cricket"];
              ...
              <div className="mt-5 rounded-2xl bg-slate-900/5 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-extrabold text-slate-900">
                    {idx === 2 ? "Upcoming big match" : "In progress"}
                  </span>
                </div>
